...
image:
  caption: '_Red-necked stints travel from Australia to Siberia to breed. Picture: [JJ Harrison](https://www.jjharrison.com.au)._'
  focal_point: 'center'
output:
  blogdown::html_page:
    toc: true
    toc_depth: 1
categories: [aiv, migration]
tags: [post]
---
...
```{r echo = FALSE, fig.align='center', fig.cap="_The migration routes of Red-necked Stints have substantial overlap with areas where HPAIV is endemic. Credit Simeon Lisovski as part of ongoing projects with the Victorian Wader Study Group._"}
